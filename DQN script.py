...
Original file is located at
    https://colab.research.google.com/drive/1H5dC953uiEQrp_Ha5CKnNzFAnWfbnanN
"""
...
class MazeDQN(nn.Module):
    def __init__(self, input_channels=3, maze_size=10, num_actions=4):
        ...
        # Fully connected layers  # Define fc1 and fc2 here
...
class DQNAgent:
    ...
    def select_action(self, state):
        ...
        state_tensor = torch.FloatTensor(state).unsqueeze(0).permute(0, 3, 1, 2).to(device)  # Add batch dim and reorder to BCHW
        with torch.no_grad():
...
def train_maze_agent(maze_size=10, episodes=50, render=False, seed=42):
    ...
    # Create environment with fixed maze
    env = MazeEnv(maze_size=maze_size, seed=seed)

    # Keep the maze fixed throughout training
    ...
    # Increase epsilon decay for faster convergence in 50 episodes
    ...
    for episode in range(episodes):
        ...
        # Update target network more frequently for faster learning
        if episode % 5 == 0:
...
def visualize_agent_path(agent, env, fixed_maze, max_steps=200):
    # Reset environment with the same fixed maze
    ...
    # Create a colorful representation of the maze
    ...
    # Path is red gradient (more red as steps increase)
